...
// Template data structure matching the React implementation exactly
const templateData = {
  hero: {
    name: "{{chea Ilong}}",
    title: "{{hero.title}}",
  ...
  about: {
    ...
    image: "{{about.image}}",
    skills: ["{{about.skills.0}}", "{{about.skills.1}}", "{{about.skills.2}}", "{{about.skills.3}}", "{{about.skills.4}}", "{{about.skills.5}}"]
  },
  portfolio: {
    ...
    projects: [
      {
        ...
        image: "{{portfolio.projects.0.image}}",
        tags: ["{{portfolio.projects.0.tags.0}}", "{{portfolio.projects.0.tags.1}}"]
      },
      {
        id: 2,
        title: "{{portfolio.projects.1.title}}",
        description: "{{portfolio.projects.1.description}}",
        image: "{{portfolio.projects.1.image}}",
        tags: ["{{portfolio.projects.1.tags.0}}", "{{portfolio.projects.1.tags.1}}"]
      },
      {
        id: 3,
        title: "{{portfolio.projects.2.title}}",
        description: "{{portfolio.projects.2.description}}",
        image: "{{portfolio.projects.2.image}}",
        tags: ["{{portfolio.projects.2.tags.0}}", "{{portfolio.projects.2.tags.1}}"]
      }
    ],
    projectsCount: "{{portfolio.projectsCount}}",
    technologiesCount: "{{portfolio.technologiesCount}}",
  ...
  contact: {
    ...
    social_links: [
      { platform: "{{contact.social_links.0.platform}}", url: "{{contact.social_links.0.url}}" },
      { platform: "{{contact.social_links.1.platform}}", url: "{{contact.social_links.1.url}}" },
      { platform: "{{contact.social_links.2.platform}}", url: "{{contact.social_links.2.url}}" }
    ]
  }
};

// Generate the exact HTML matching the React template
const generateExactHTML = () => {
    ...
    <div class="max-w-7xl mx-auto px-6">
      ...
      <div class="mt-16 grid grid-cols-2 md:grid-cols-4 gap-6">
        <div class="text-center p-6 rounded-xl bg-white/50 backdrop-blur-sm">
          <div class="text-3xl font-bold text-gray-900">${templateData.portfolio.projectsCount || '3'}</div>
          <div class="text-sm text-gray-600 mt-1">Projects</div>
        </div>
        <div class="text-center p-6 rounded-xl bg-white/50 backdrop-blur-sm">
          <div class="text-3xl font-bold text-gray-900">${templateData.portfolio.technologiesCount || '12'}</div>
