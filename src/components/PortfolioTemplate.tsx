  ...
  return (
    <html lang="en">
      <head>
        ...
        <title>{`${replaceWith('name', name)} - ${replaceWith('title', title)} Portfolio`}</title>
        <meta name="description" content={replaceWith('description', description)} />
        <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&display=swap" rel="stylesheet" />
        <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css" rel="stylesheet" />
      </head>
      <body className="font-sans text-gray-900 leading-relaxed">
        {/* Navigation */}
