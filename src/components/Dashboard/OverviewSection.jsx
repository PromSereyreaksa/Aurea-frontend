  ...
  const statsData = [
    {
      ...
      change:
        portfolios.length === 1 ? "portfolio created" : "portfolios created",
      changeType: "neutral",
      color: "orange",
    },
    {
      ...
      change:
        portfolios.length > 0
          ? `${publishedPortfolios} of ${portfolios.length} live`
          : "0 portfolios",
      changeType: "neutral",
      color: "green",
    },
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="relative mb-12 overflow-hidden">
        {/* Gradient Blobs - Background only - Hidden on mobile */}
        <div className="hidden md:block absolute top-0 right-0 w-[500px] h-[500px] bg-gradient-to-br from-[#fb8500]/10 via-purple-500/10 to-blue-500/10 rounded-full blur-3xl -z-10"></div>
        <div className="hidden md:block absolute bottom-0 left-0 w-[400px] h-[400px] bg-gradient-to-tr from-[#fb8500]/10 to-pink-500/10 rounded-full blur-3xl -z-10"></div>

        {/* Welcome Header */}
        <div className="relative z-10">
          <h1 className="text-3xl md:text-4xl font-bold tracking-tight leading-none mb-6 text-[#1a1a1a] relative z-10">
          ...
          <div className="animate-fade-in">
            {unpublishedPortfolios > 0 ? (
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 p-5 bg-orange-50 rounded-xl">
                <div className="flex items-start gap-3 flex-1">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-neutral-700">
                      Finish or continue building your portfolio to publish it
                ...
                <Link
                  to={
                    latestUnpublishedPortfolio
                      ? `/portfolio-builder/${latestUnpublishedPortfolio._id}`
                      : "/portfolio-builder/new"
                  }
                  className="px-5 py-2.5 bg-[#fb8500] hover:bg-[#ff9500] text-white font-medium text-sm rounded-lg transition-all duration-300 hover:shadow-lg flex-shrink-0 uppercase tracking-wide"
                >
                  Continue Editing
                </Link>
              </div>
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 p-5 bg-green-50 border-2 border-green-200 rounded-xl">
                <div className="flex items-start gap-3 flex-1">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-neutral-700">
                      Keep creating amazing work or edit your existing
                      portfolios to keep them fresh.
                    </p>
                  </div>
                </div>
                <Link
                  to={
                    portfolios[0]
                      ? `/portfolio-builder/${portfolios[0]._id}`
                      : "/portfolio-builder/new"
                  }
                  className="px-5 py-2.5 bg-green-600 hover:bg-green-700 text-white font-medium text-sm rounded-lg transition-all duration-300 hover:shadow-lg flex-shrink-0 uppercase tracking-wide"
                >
                  Continue Editing
                </Link>
              </div>
              ...
              <p className="text-lg text-neutral-600">
                Manage your portfolios, track performance, and create stunning
                designs.
              </p>
            )}
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="bg-white border-2 border-neutral-200 p-6 rounded-xl hover:border-[#fb8500] transition-all duration-300 hover:shadow-lg">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs text-neutral-500 uppercase font-semibold tracking-wide mb-2">
                  Total Portfolios
                </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
          ...
          >
            ...
            <div className="flex-1">
              <p className="font-semibold text-[#1a1a1a] text-sm">Create New</p>
          ...
          >
            ...
            <div className="flex-1 text-left">
              <p className="font-semibold text-[#1a1a1a] text-sm">View All</p>
          ...
          >
            ...
            <div className="flex-1">
              <p className="font-semibold text-[#1a1a1a] text-sm">Settings</p>
            ...
            <div className="p-6">
              ...
              {portfolios.length === 0 ? (
                <div className="flex flex-col items-center justify-center text-center rounded-xl border-2 border-dashed border-neutral-300 p-8">
                  ...
                  <p className="text-sm text-neutral-600 font-bold mb-1">
                    No portfolios yet
                  </p>
                  ...
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-2 mb-3">
                        ...
                        {(portfolios[0].isPublished ||
                          portfolios[0].published) && (
                    ...
                    <svg
                      className="w-5 h-5 text-neutral-400 group-hover:text-[#fb8500] group-hover:translate-x-1 transition-all duration-300"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
          ...
          <div className="bg-white border-2 border-neutral-200 rounded-xl overflow-hidden hover:shadow-lg transition-all duration-300 h-full">
            <div className="p-6">
              ...
              {publishedPortfolios === 0 ? (
                ...
                (() => {
                  const publishedPortfolio = portfolios.find(
                    (p) => p.isPublished || p.published
                  );
                  return publishedPortfolio ? (
                    ...
                    >
                      <div className="flex items-start justify-between mb-4">
                        <div className="flex-1">
                          <h3 className="text-lg font-black text-[#1a1a1a] mb-2 group-hover:text-[#fb8500] transition-colors duration-300">
                            {publishedPortfolio.name ||
                              publishedPortfolio.title ||
                              "Untitled Portfolio"}
                          </h3>
                          <div className="flex items-center gap-2 mb-3">
                            <span className="inline-block px-3 py-1 bg-neutral-100 rounded-lg text-xs font-bold text-neutral-600 uppercase">
