...
const events = [
  ...
  },
  {
    ...
    description:
      "Stay ahead with the latest web design trends, tools, and implementation strategies",
  },
  {
    id: 8,
    ...
    description:
      "Monthly gatherings featuring workshops, talks, and collaborative design sessions",
  },
  {
    id: 9,
    ...
    description:
      "Bridge the gap between design and development with practical coding skills",
  },
];
...
const EventsSection = () => {
  ...
  return (
    <section
      id="events"
      className="py-32 px-6 bg-gradient-to-br from-blue-50/30 to-purple-50/20"
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
            Elevate your design practice through our comprehensive bootcamps,
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Learn advanced design techniques, industry best practices,
                      and cutting-edge tools from expert practitioners.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Master pricing strategies, client management, contract
                      negotiation, and building sustainable creative businesses.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Connect with like-minded designers, potential
                      collaborators, mentors, and industry leaders in your
                      field.
                    </p>
                  </div>
                </div>
