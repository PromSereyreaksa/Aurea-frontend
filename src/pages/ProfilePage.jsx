    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <button
          ...
          className="flex items-center gap-2 text-gray-600 hover:text-[#fb8500] transition-colors mb-6 group"
        >
            ...
            <div className="relative flex items-center">
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute bottom-0 right-0 w-8 h-8 bg-[#fb8500] text-white rounded-full flex items-center justify-center shadow-lg hover:bg-[#fb8500]/90 transition-colors"
                >
                  <Camera size={16} />
                </button>
              </div>
              <div className="ml-6 flex-1">
                ...
                <div className="flex gap-2 mt-3">
                  <button
                    onClick={handleCustomizationClick}
                    className="px-4 py-2 bg-[#fb8500] text-white rounded-lg font-medium hover:bg-[#fb8500]/90 transition-colors flex items-center gap-2"
                  >
                    <Edit3 size={16} />
                    Edit Profile
                  </button>
        ...
        <div className="mt-8 grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            {/* Account Status */}
            <div className="bg-white rounded-lg shadow-lg p-6">
              <h3 className="text-lg font-semibold text-[#1a1a1a] mb-4">Account Status</h3>
