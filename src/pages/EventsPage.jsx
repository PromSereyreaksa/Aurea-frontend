...
const EventsPage = () => {
  ...
  const events = [
    {
      ...
      description:
        "Master the art of leading design teams and driving creative vision in organizations",
    ...
    },
    {
      ...
      description:
        "Join industry leaders for cutting-edge design trends and networking opportunities",
    ...
    },
    {
      ...
      description:
        "Deep dive into brand strategy, visual identity, and storytelling techniques",
    ...
    },
    {
      ...
      description:
        "Learn pricing strategies, client management, and freelance business fundamentals",
    ...
    },
    {
      ...
      description:
        "Advanced techniques in UI/UX design, prototyping, and user research methodologies",
    ...
    },
    {
      ...
      description:
        "Transform your portfolio into a client-attracting powerhouse that wins projects",
  ...
  return (
    <div className="app-page min-h-screen bg-white text-black font-sans">
      ...
      <section
        id="home"
        className="min-h-screen flex flex-col items-center justify-center px-6 pt-20 pb-12 bg-gradient-to-br from-gray-50 to-blue-50/30"
      >
        <div className="text-center space-y-8 max-w-5xl mx-auto">
          ...
          <p className="text-xl md:text-2xl text-gray-600 max-w-3xl mx-auto leading-relaxed mb-8">
            Elevate your design career through our comprehensive training
            programs. From creative mastery to business excellence, we've
            crafted experiences that transform talented designers into industry
            leaders.
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Our carefully curated workshops and events are designed to bridge
              the gap between creative talent and business success. Whether
              you're a seasoned designer looking to lead or a newcomer seeking
              foundational skills, our programs offer practical knowledge you
              can immediately apply to your career.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">
                ...
                experience in design leadership and creative business
                management.
              </p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">
                Connect with like-minded creatives, potential collaborators, and
                industry leaders who can accelerate your career growth.
              </p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">
                Gain actionable insights and tools that you can immediately
                implement in your current projects and career development.
              </p>
            </div>
          </div>
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-gray-700">
                    Strategic thinking approaches for creative problem-solving
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-[#fb8500] rounded-full mt-2 flex-shrink-0"></div>
                  <p className="text-gray-700">
                    Business fundamentals every creative professional needs
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-[#fb8500] rounded-full mt-2 flex-shrink-0"></div>
                  <p className="text-gray-700">
                    Portfolio optimization techniques that attract clients
                  </p>
                </div>
              </div>
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-[#fb8500] rounded-full mt-2 flex-shrink-0"></div>
                  <p className="text-gray-700">
                    Leadership skills for managing creative teams
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-[#fb8500] rounded-full mt-2 flex-shrink-0"></div>
                  <p className="text-gray-700">
                    Pricing strategies that reflect your true value
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-[#fb8500] rounded-full mt-2 flex-shrink-0"></div>
      ...
      <section id="events" className="py-20 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-xl text-gray-600 text-center max-w-3xl mx-auto mb-8">
            Join our carefully curated workshops and bootcamps designed to push
            the boundaries of your creative potential and business acumen.
          </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {events.map((event, index) => (
              <div
                key={event.id}
                className="group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-100 hover:border-[#fb8500]/30 overflow-hidden"
              >
      ...
      <section
        id="newsletter"
        className="py-20 px-6 bg-gradient-to-br from-blue-50/30 to-purple-50/20"
      >
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 leading-relaxed">
            Be the first to know about our latest workshops, bootcamps, and
            creative events. Get exclusive access to early bird registration and
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg max-w-2xl mx-auto">
            ...
            <p className="text-sm text-gray-500 mt-4">
              Join our community of creative professionals and never miss an
              opportunity to level up your design career.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="bg-white rounded-lg p-8 max-w-md w-full mx-4 relative">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                Our workshop registration system is currently being enhanced to
                provide you with the best experience. Please check back soon!
              </p>
              <button
                onClick={closeMaintenanceModal}
        ...
        <div className="fixed inset-0 bg-white bg-opacity-5 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg p-8 max-w-md w-full mx-4 relative">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                <strong>Welcome to our community!</strong> We'll be informing
                you about upcoming workshops, exclusive events, and creative
                opportunities. Stay tuned for exciting updates!
              </p>
              <div className="bg-orange-50 border border-orange-200 rounded-lg p-4 mb-6">
                <p className="text-orange-700 text-sm">
                  <strong>What's next?</strong> Check your email for a welcome
                  message and be ready for amazing design events coming your
                  way.
                </p>
              </div>
              <button
